...
export default function HeaderNav({ autheticated = false, ...props }) {
    ...
    return (
        <nav className="fixed flex w-full h-fit min-h-[60px] z-[100] top-0 left-0 max-w-full items-center md:shadow-sm overflow-hidden bg-white font-medium text-sm">
            ...
            <div style={{height: `${window.innerHeight}px`}} className={"flex flex-col md:flex-row items-start md:items-center fixed md:static z-10 top-0 w-full md:w-fit md:!h-fit overflow-y-auto overflow-x-hidden md:overflow-hidden pt-[60px] md:pt-0 ml-0 md:ml-auto bg-white transition-all " + (isNavigationOpen ? "left-0" : "left-full")}>
